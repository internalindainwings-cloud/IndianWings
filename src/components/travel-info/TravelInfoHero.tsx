          ...
          <div className="w-full lg:w-1/2 max-w-xl flex flex-col items-start text-left">
            ...
            <nav aria-label="Breadcrumb" className="mb-2.5 sm:mb-3">
              <ol className="flex items-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs font-manrope text-warm-white/70">
                ...
                <li>
                  <span className="text-warm-white/80">Kashmir Bucket List</span>
                </li>
                <ChevronRight size={12} className="text-warm-white/40 shrink-0" />
                <li>
                  <span className="text-saffron font-semibold">Travel Information</span>
                </li>
              </ol>
            </nav>

            {/* Major Heading - One Line */}
            <h1 className="font-display text-[17px] min-[360px]:text-[19px] min-[400px]:text-[22px] min-[480px]:text-2xl sm:text-3xl md:text-4xl lg:text-[38px] xl:text-[44px] text-saffron leading-tight tracking-tight whitespace-nowrap drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)] mb-3 sm:mb-4">
              Kashmir Travel Information &amp; Guide
            </h1>
            ...
            <div className="flex flex-row items-center gap-2 sm:gap-3 w-full sm:w-auto">
              ...
              >
                <span>Read Essential Rules</span>
