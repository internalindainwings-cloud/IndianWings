  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        if (json.success && Array.isArray(json.activities) && json.activities.length > 0 && isMounted) {
            ...
            >
              ...
              <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-3">
                ...
                <div className="pt-3 border-t border-black/[0.08] flex items-center gap-2">
                  ...
                  <a
                    href={`https://wa.me/917006837096?text=Hi%20The%20Indian%20Wings%20Company,%20I%20want%20to%20enquire%20about%20booking%20${encodeURIComponent(act.name)}%20in%20${encodeURIComponent(act.location)}.`}
                    target="_blank"
