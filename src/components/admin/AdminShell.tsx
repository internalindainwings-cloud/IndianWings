...
const sectionLabels: Record<AdminSection, string> = {
  ...
  pageheroes: 'Page Hero Banners & Mobile Backgrounds',
  ...
  'bucket-list': 'Kashmir Bucket List Hub',
  'bucket-travel-info': 'Bucket List — Travel Information',
  'bucket-shopping': 'Bucket List — Shopping Guide',
  'bucket-things-to-do': 'Bucket List — Things to Do',
  reviews: 'Customer Reviews & Stories',
  gallery: 'Media Gallery Manager (Photos & Videos)',
