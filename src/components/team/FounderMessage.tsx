...
export function FounderMessage({
  imageSrc = '/images/team/founder-komal.jpg',
}: FounderMessageProps) {
  ...
  return (
    <section
      id="founder"
      aria-label="Message from Mrs. Komal Rai"
    ...
    >
      <div className="max-w-[1020px] mx-auto px-5 sm:px-8">
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 lg:p-10 border border-black/8 shadow-xs flex flex-col md:flex-row items-center md:items-start gap-6 sm:gap-8 lg:gap-10">
          ...
          <div className="relative w-40 h-52 sm:w-48 sm:h-64 rounded-xl overflow-hidden border border-black/10 shadow-sm shrink-0 bg-slate-100">
            <Image
              src={imageSrc}
          ...
          <div className="flex flex-col justify-between flex-grow space-y-3.5 text-left">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              ...
              <a
                href={`https://wa.me/${cleanPhone}?text=${encodeURIComponent('Hello Mrs. Komal Rai & The Indian Wings team, I would like to discuss my Kashmir travel plans.')}`}
                target="_blank"
